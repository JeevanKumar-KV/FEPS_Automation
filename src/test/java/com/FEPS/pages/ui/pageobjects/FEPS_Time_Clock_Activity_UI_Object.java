...
public class FEPS_Time_Clock_Activity_UI_Object extends PageBase {

	public FEPS_Time_Clock_Activity_UI_Object(WebDriver driver) {
		super(driver);
	}
	
	@FindBy(how = How.XPATH, using = "//a[text()='Time Clock Activity']")
	public WebElement Time_Clock_Activity;
    ...
    @FindBy(how = How.XPATH, using = "//a[@title='Time Clock Requests Manager']")
   	public WebElement Time_Clock_Requests_Manager;
